...
subTotalItem2.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem2 * priceItem2);
subTotalItem3.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem3 * priceItem3);
subTotalItem4.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem4 * priceItem4);
subTotalItem5.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem5 * priceItem5);
subTotalItem6.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem6 * priceItem6);
subTotalItem7.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem7 * priceItem7);
subTotalItem8.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem8 * priceItem8);
subTotalItem9.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem9 * priceItem9);
subTotalItem10.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem10 * priceItem10);
subTotalItem11.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
  }).format( qtdItem11 * priceItem11);
subTotalItem12.innerText = new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "CAD"
